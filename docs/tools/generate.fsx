...
let referenceBinaries = ["MemoryWayback/MemoryWayback.exe"]
// Web site location for the generated documentation
let website = "/MemoryWayback"

let githubLink = "http://github.com/willryan/MemoryWaybackAPI"

// Specify more information about your project
let info =
  [ "project-name", "MemoryWayback"
    "project-author", "Will Pleasant-Ryan"
    "project-summary", "browse through old memories (photos, videos)"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/MemoryWayback" ]
